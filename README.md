...
**My unpublished fork, that mirror's console.log (and .info, .warn & .error) from the web page to the server's console. All of the info below is for [gulp-server-livereload](https://github.com/hiddentao/gulp-server-livereload) and not this fork**
